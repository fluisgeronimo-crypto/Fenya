      ...
      >
                  ...
                  <div className="flex flex-1 flex-col">
                    ...
                    <div className="mt-2 flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="ml-auto text-xs text-ink-soft underline decoration-powder underline-offset-2 hover:text-rose-deep"
                      >
                        Quitar
                      </button>
                    </div>
        ...
        <div className="border-t border-line px-6 py-6">
          ...
          <button
            ...
            className="w-full rounded-full bg-rose py-3.5 text-center text-xs tracking-wide text-ivory transition-colors hover:bg-rose-deep disabled:cursor-not-allowed disabled:opacity-40"
          >
            {loading ? "REDIRIGIENDO A PAGO…" : "IR A PAGAR"}
          </button>
          {error && (
            <p className="mt-3 text-center text-[11px] text-rose-deep">
              {error}
            </p>
          )}
        </div>
