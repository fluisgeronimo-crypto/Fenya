  ...
  return (
    <footer id="contacto" className="mt-24 bg-ink py-16 text-ivory">
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-10 px-6 md:grid-cols-4 md:px-8">
        ...
        <div>
          <h4 className="mb-4 text-sm tracking-wide text-powder">
            Navegación
          </h4>
        ...
        <div>
          <h4 className="mb-4 text-sm tracking-wide text-powder">Ayuda</h4>
          <ul className="flex flex-col gap-2.5 text-sm text-ivory/80">
            <li>Envíos</li>
            <li>Devoluciones</li>
      ...
      <div className="mx-auto mt-14 flex max-w-6xl flex-wrap justify-between gap-3 border-t border-ivory/10 px-6 pt-6 text-sm text-ivory/60 md:px-8">
