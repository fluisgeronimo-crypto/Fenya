    ...
    <main>
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-10 pt-16 md:grid-cols-[1fr_0.95fr] md:px-8 md:pt-20">
        <div>
          ...
          <h1 className="max-w-[9.5ch] font-serif text-4xl italic leading-[1.1] sm:text-5xl md:text-6xl">
            Tu piel, tu ritual.
          </h1>
          ...
          <div className="mt-9 flex items-center gap-6">
            <Link
              href="/productos"
              className="rounded-full bg-rose px-8 py-3.5 text-sm tracking-wide text-ivory transition-colors hover:bg-rose-deep"
            >
              DESCUBRIR FÉNYA
            </Link>
            <Link
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 md:px-8">
        <div className="rounded-[28px] bg-gradient-to-br from-rose to-rose-deep px-8 py-16 text-center text-ivory md:px-16">
          ...
          <Link
            href="/productos"
            className="mt-7 inline-block rounded-full bg-ivory px-8 py-3.5 text-sm tracking-wide text-rose-deep transition-colors hover:bg-white"
          >
            VER PRODUCTOS
          </Link>
        </div>
